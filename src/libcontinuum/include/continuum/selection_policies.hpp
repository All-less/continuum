#ifndef CONTINUUM_LIB_SELECTION_POLICIES_H
#define CONTINUUM_LIB_SELECTION_POLICIES_H
...
/**
 * An instance of a SelectionPolicy class must be stateless and Continuum
 ...
 * which is managed by Continuum and stored in a persistent
 * database. The separate of policy and state allows Continuum to re-use
...
#endif  // CONTINUUM_LIB_SELECTION_POLICIES_H
